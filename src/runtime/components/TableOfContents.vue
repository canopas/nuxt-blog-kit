<template>
  <div class="cb-relative cb-w-full xl:cb-w-[45%] cb-tracking-tight cb-text-black-core/[0.87]">
    <div class="xl:cb-sticky cb-top-[7.5rem] cb-flex cb-flex-col">
      ...
      >
        ...
        <div
          class="cb-pl-5 cb-pr-6 lg:cb-pl-4 lg:cb-pr-4 2xl:cb-pl-5 2xl:cb-pr-6 cb-leading-relaxed"
        >
