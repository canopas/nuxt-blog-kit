<template>
  <div>
    <span
      className="cb-text-[1.6875rem] lg:cb-text-[2rem] xl:cb-text-[1.5625rem] cb-capitalize cb-font-inter-medium"
    >
      Recommended for you
    </span>
      ...
      >
        ...
        >
          <div class="cb-flex cb-flex-col cb-col-span-2 cb-space-y-2">
            ...
            <div
              class="cb-hidden xl:cb-block cb-text-black-core/[0.65] cb-text-[0.875rem] !cb-tracking-wide"
            >
